...
public class ProbSiteClassTable extends SiteClassTable {
    ...
    protected void makeTable(){
        ...
        for (int iSite = 0; iSite < this.siteClassProbs.length; iSite++) {
            ...
            for (int iGene = 1; iGene < numberOfGenes; iGene++) { // start at 1 to avoid noncoding gene
...
//        double[][][] data = new double[][][]{ // 5 sites and 3 genes. NB includes noncoding gene
//            {{ -1.0, -1.0, -1.0 }, { 0.123456, 0.7891011, 0.94999999999999999 }, { 0.123456, 0.7891011, 0.08744289999999999 }, { 0.123456, 0.7891011, 0.08744289999999999 }},
//            {{ -1.0, -1.0, -1.0 }, { 0.123456, 0.7891011, 0.08744289999999999 }, { 0.123456, 0.7891011, 0.08744289999999999 }, { 0.123456, 0.7891011, 0.08744289999999999 }},
//            {{ -1.0, -1.0, -1.0 }, { 0.123456, 0.7891011, 0.08744289999999999 }, { 0.123456, 0.7891011, 0.08744289999999999 }, { 0.123456, 0.7891011, 0.08744289999999999 }},
//            {{ -1.0, -1.0, -1.0 }, { 0.123456, 0.7891011, 0.08744289999999999 }, { 0.123456, 0.7891011, 0.08744289999999999 }, { 0.123456, 0.7891011, 0.08744289999999999 }},
//            {{ -1.0, -1.0, -1.0 },{ 0.123456, 0.7891011, 0.08744289999999999 }, { 0.123456, 0.7891011, 0.08744289999999999 }, { 0.123456, 0.7891011, 0.08744289999999999 }},
//        };
